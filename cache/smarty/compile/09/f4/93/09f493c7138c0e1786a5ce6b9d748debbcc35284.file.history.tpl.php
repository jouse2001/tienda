<?php /* Smarty version Smarty-3.1.19, created on 2014-12-15 21:08:57
         compiled from "/var/www/tienda/themes/default-bootstrap/history.tpl" */ ?>
<?php /*%%SmartyHeaderCode:857249195548f4de9834e76-16494004%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '09f493c7138c0e1786a5ce6b9d748debbcc35284' => 
    array (
      0 => '/var/www/tienda/themes/default-bootstrap/history.tpl',
      1 => 1406810456,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '857249195548f4de9834e76-16494004',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_548f4de992f9a0_06861441',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_548f4de992f9a0_06861441')) {function content_548f4de992f9a0_06861441($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_regex_replace')) include '/var/www/tienda/tools/smarty/plugins/modifier.regex_replace.php';
?>
...
<?php $_tmp4=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order-opc',true,null,"submitReorder&id_order=".$_tmp4), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Reorder'),$_smarty_tpl);?>
">
							<?php } else { ?>
								<a class="link-button" href="<?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['order']->value['id_order']);?>
<?php $_tmp5=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,null,"submitReorder&id_order=".$_tmp5), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Reorder'),$_smarty_tpl);?>
">
							<?php }?>
