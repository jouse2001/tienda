...
<p class="payment_module">
	<a class="bankwire" href="javascript:$('#redsys_form').submit();" title="{l s='Conectar con el TPV' mod='redsys'}" style="float:left;width:100%">
		
		<img src="{$module_dir|escape:'htmlall'}img/tarjetas_redsys.png" alt="{l s='Conectar con el TPV' mod='redsys'}" style="float:left; margin: 0px 10px 5px 0px;"/>
